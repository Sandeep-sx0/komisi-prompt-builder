                            ...
                            <AnimatePresence>
                              {isSpotlit && showBadge && (
                                <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                                  ...
                                  style={{ backgroundColor: "#000000", color: "#FFFFFF", borderRadius: "4px" }}>🏆 Top</motion.span>
                              )}
                            </AnimatePresence>
                          </span>
            ...
            <AnimatePresence>
              {showTooltip && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                  ...
                  style={{ backgroundColor: "#111111", borderRadius: "8px", border: "1px solid rgba(0,0,0,0.2)" }}>
