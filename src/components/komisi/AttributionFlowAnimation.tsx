          ...
          <motion.div key="s1" {...fade} transition={{ duration: fadeIn.duration, ease: fadeIn.ease }}
            ...
            <div className="w-[260px] p-5 shadow-xl" style={{ backgroundColor: "#FFFFFF", borderRadius: "16px" }}>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm" style={{ color: "#111111", fontWeight: 400 }}>@sarah_creates</span>
              </div>
          ...
          <motion.div key="s2" {...fade} transition={{ duration: fadeIn.duration, ease: fadeIn.ease }}
            ...
            <div className="w-[260px] p-5 shadow-xl" style={{ backgroundColor: "#FFFFFF", borderRadius: "16px" }}>
              <div className="flex items-center gap-3 mb-3">
                <div className="w-12 h-12" style={{ borderRadius: "12px", background: "linear-gradient(135deg, #111111, #111111)" }} />
                <div>
                  <p className="text-sm" style={{ color: "#111111", fontWeight: 400 }}>FocusTimer</p>
              ...
              <div className="relative">
                <motion.button
                  ...
                  style={{ backgroundColor: "#000000", borderRadius: "20px", fontWeight: 400 }}
                  animate={cursorTap ? { scale: [1, 0.95, 1] } : {}}
                  transition={{ duration: 0.15 }}
                >GET</motion.button>
                {getRingProgress > 0 && (
                  <div className="mt-2 w-full h-1 overflow-hidden" style={{ backgroundColor: "rgba(0,0,0,0.15)", borderRadius: "2px" }}>
                    <div className="h-full" style={{ backgroundColor: "#000000", borderRadius: "2px", width: `${getRingProgress * 100}%`, transition: "width 16ms linear" }} />
                  </div>
                )}
              </div>
            </div>
          ...
          <motion.div key="s5" {...fade} transition={{ duration: fadeIn.duration, ease: fadeIn.ease }}
            ...
            <div className="w-[280px] p-6 shadow-xl" style={{ backgroundColor: "#FFFFFF", borderRadius: "16px" }}>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-sm" style={{ color: "#111111", fontWeight: 400 }}>Commission Queued</span>
              ...
              <p className="text-2xl mb-1" style={{ color: "#111111", fontWeight: 400 }}>$3.00</p>
