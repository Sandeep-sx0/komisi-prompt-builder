...
const HeroDashboard: React.FC = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: '#111827', minHeight: 380 }}
    >
      ...
      {/* Top bar */}
      <div className="flex items-center justify-between px-4 py-2.5" style={{ borderBottom: '1px solid #111827' }}>
      ...
      <div className="grid grid-cols-5 gap-1.5 px-3 py-2.5">
        {metrics.map((m) => (
          <div
            ...
            style={{
              backgroundColor: installBump && m.key === 'installs' ? 'rgba(74,222,128,0.1)' : '#111827',
      ...
      {/* Divider */}
      <div className="mx-3" style={{ height: 1, backgroundColor: '#111827' }} />
              ...
              <div className="space-y-1.5">
                {activityRows.map((row, i) => (
                  <div
                    ...
                    style={{ backgroundColor: '#111827', ...fade(visibleActivity > i) }}
                  >
          ...
          {scene === 3 && (
            <div className="relative">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[9px]" style={{ color: '#0891B2' }}>View All →</span>
              </div>
              ...
              <div
                ...
                style={{ backgroundColor: '#111827', ...fade(showTooltip) }}
              >
        ...
        {[1, 2, 3, 4].map(s => (
          <div
            ...
            style={{
              width: scene === s ? 6 : 4,
              height: scene === s ? 6 : 4,
              backgroundColor: scene === s ? '#FFFFFF' : '#111827',
