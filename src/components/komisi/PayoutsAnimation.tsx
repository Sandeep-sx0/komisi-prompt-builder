                          ...
                          <AnimatePresence mode="wait">
                            {paidRows[i] ? (
                              <motion.span
                                ...
                                style={{ backgroundColor: "#4ADE80", color: "#FFFFFF", borderRadius: "4px" }}
                              >
                                Paid ✔
                              </motion.span>
                            ) : (
                              <motion.span
                                ...
                                transition={{ duration: 0.6 }}
                                className="text-[10px] px-2 py-0.5"
                                style={{ color: "#9CA3AF", border: "1px solid #E5E7EB", borderRadius: "4px" }}
                              >
                                Pending
                              </motion.span>
                            )}
                ...
                <AnimatePresence mode="wait">
                  {allDone ? (
                    <motion.span
                      ...
                      style={{ color: "#4ADE80", backgroundColor: "rgba(74,222,128,0.1)", borderRadius: "6px" }}
                    >
                      Completed
                    </motion.span>
                  ) : (
                    <motion.span
                      ...
                      transition={{ duration: 0.6 }}
                      className="text-[10px] px-3 py-1.5"
                      style={{ backgroundColor: "#0C1C28", color: "#FFFFFF", borderRadius: "6px" }}
                    >
                      Process All Payouts
                    </motion.span>
                  )}
