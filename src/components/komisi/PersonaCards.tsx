  ...
  const renderCode = () => {
    ...
    if (rest1.length <= configure.length) {
      return (
        <>
          ...
          <span style={{ color: "#0891B2" }}>{rest1}</span>
        </>
      );
    }
    ...
    if (rest2.length <= key.length) {
      return (
        <>
          <span className="text-white">{sdk}</span>
          <span style={{ color: "#0891B2" }}>{configure}</span>
    ...
    return (
      <>
        ...
        <span style={{ color: "#0891B2" }}>{rest2.slice(key.length)}</span>
      </>
    );
  };
    ...
    <div className="h-full flex flex-col justify-center px-6 py-5 space-y-3">
      ...
      >
        <span
          ...
          style={{
            backgroundColor: phase >= 1 ? "rgba(8,145,178,0.3)" : "rgba(255,255,255,0.05)",
      ...
      >
        <div className="flex items-center gap-3 mb-2">
          <span
            className="w-6 h-6 shrink-0 flex items-center justify-center text-[10px]"
            style={{
              backgroundColor: phase >= 2 ? "rgba(8,145,178,0.4)" : "rgba(255,255,255,0.05)",
              color: "white",
              borderRadius: "50%",
            }}
          >
...
const PersonaCard = ({ label, chips, visual, delay = 0 }: PersonaCardProps) => {
  return (
    ...
    >
      <div className="h-[240px]" style={{ backgroundColor: "#111827" }}>
        {visual}
      </div>
