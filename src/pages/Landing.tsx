  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-24 px-6 relative overflow-hidden" style={{ backgroundColor: "#FFF8EE" }}>
        <div className="absolute inset-0 z-0 pointer-events-none" <div className="absolute inset-0 z-0 pointer-events-none" style={{ backgroundImage: "url('/backgrounds/BG 14.jpg.jpeg')", backgroundSize: "cover", backgroundPosition: "center" }} /> />
