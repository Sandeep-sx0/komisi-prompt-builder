...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center">
            <motion.span
              animate={{ color: isPastHero ? '#09090B' : '#FFFFFF' }}
              transition={{ duration: 0.35, ease: [0.16, 1, 0.3, 1] }}
            ...
            {["Product", "Pricing", "Docs", "Marketplace"].map(l => {
              ...
              const linkProps = isLink
                ...
                : {
                    ...
                    transition: { duration: 0.35, ease: [0.16, 1, 0.3, 1] },
                    onMouseEnter: (e: React.MouseEvent) => { (e.target as HTMLElement).style.color = isPastHero ? '#09090B' : '#FFFFFF'; },
              ...
              if (isLink) {
                return (
                  <Link key={l} to="/pricing" className="text-sm" style={{ cursor: 'pointer', color: isPastHero ? '#374151' : 'rgba(255,255,255,0.85)', transition: 'color 0.35s cubic-bezier(0.16, 1, 0.3, 1)' }}
                    onMouseEnter={(e) => { (e.target as HTMLElement).style.color = isPastHero ? '#09090B' : '#FFFFFF'; }}
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link to="/signup"><Button size="sm" style={{ backgroundColor: isPastHero ? '#09090B' : '#0891B2', color: '#FFFFFF' }} className="hover:opacity-90 transition-colors duration-300">Get Started <ArrowRight size={14} /></Button></Link>
          </div>
          <button className="md:hidden" onClick={() => setMobileMenu(!mobileMenu)}>
            <motion.span animate={{ color: isPastHero ? '#09090B' : '#FFFFFF' }} transition={{ duration: 0.35, ease: [0.16, 1, 0.3, 1] }}>
          ...
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                ...
                <Link to="/signup">
                  <Button size="lg" className="h-12 px-6 bg-white text-[#111827] hover:bg-white/90 border border-transparent">Get Started Free <ArrowRight size={16} /></Button>
                </Link>
              </motion.div>
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <div>
              ...
              <a href="#" className="text-sm hover:text-white transition-colors inline-flex items-center gap-1 mb-10" style={{ color: '#0891B2' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div>
                ...
                <a href="#" className="text-sm transition-colors inline-flex items-center gap-1 mb-8" style={{ color: '#0891B2' }}>
                  Learn how attribution works <ArrowRight size={14} />
                </a>
                <div className="p-5 mt-4" style={{ border: '1px solid rgba(8,145,178,0.15)' }}>
      ...
      <section className="w-full" style={{ backgroundColor: "#CFFAFE" }}>
        <div className="max-w-[1200px] mx-auto px-6 py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
      ...
      ═══════════════════════════════════════════ */}
      <section className="py-24 px-6" style={{ backgroundColor: "#CFFAFE" }}>
        <div className="max-w-[1200px] mx-auto">
          ...
          <Reveal className="mt-12">
            <div className="p-6 max-w-2xl mx-auto" style={{ borderLeft: '2px solid #0891B2' }}>
              <p className="text-sm text-text-secondary mb-3 leading-relaxed italic">
      ...
      ═══════════════════════════════════════════ */}
      <section style={{ backgroundColor: "#CFFAFE", padding: '80px 0' }}>
      ...
      ═══════════════════════════════════════════ */}
      <section className="py-24 px-6 relative overflow-hidden" style={{ backgroundColor: "#111827" }}>
